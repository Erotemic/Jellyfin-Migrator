...
class DemoJellyfinServerManager():
    ...
    def __init__(self):
        ...
        self.oci_container_name = 'jellyfin_dockervariant'
        self.oci_exe = find_oci_exe()
        self.url = 'http://localhost'
        self.port = '8097'
        self.verbose = 3
        # This is where local demo media will be stored
        self.test_dpath = ub.Path.appdir('jellyfin/demo/jellyfin_dockervariant')
    ...
    def ensure_server(self, populate=True, reset=False):
        """
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/Jellyfin-Migrator/tests/make_official_docker_variant.py
    """
    def main():
        demoman = DemoJellyfinServerManager()
        demoman.verbose = 3
        demoman.ensure_server(populate=False, reset=True)
